...
const Dashboard = () => {
    ...
    <form className='w-full max-w-2xl mx-auto' action={handleSubmit}>
        ...
        <div className="my-6">
            <button
                type='submit'
                className='block w-full p-2.5 text-white bg-blue-500 rounded-lg hover:bg-blue-600 focus:ring-blue-500 focus:ring-4 focus:outline-none dark:focus:ring-blue-800 font-medium text-sm'
            >
                Save
            </button>
        </div>
